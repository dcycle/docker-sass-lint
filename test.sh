...
docker run -v $(pwd)/example:/app/code dcycle/sass-lint -v -q -c /sass-lint-rules.yml /app/code/*
docker run -v $(pwd)/example:/app/code local-dcycle-sass-lint-image --help
docker run -v $(pwd)/example:/app/code local-dcycle-sass-lint-image -v -q -c /sass-lint-rules.yml /app/code/*
